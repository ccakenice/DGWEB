...
- 【2026-08-15 圣聆初雪 天赋+二技能实装 + 干员技能开关】用户要求实装圣聆初雪（6★术师 char_1046_sbell2）二技能与天赋并新增「开启选中技能」选项：天赋1「无垢的雪景」=攻击范围内地面每10秒+1层积雪（每层使经过敌人移速-10%、最多5层）；二技能「霜涛覆岭」=开启后范围内积雪每2秒额外+1层、超5层向周围扩散（最多20格）、5层地块冻结（其上敌人停止移动）、离开积雪获得5秒寒冷（移速-15%）；干员菜单新增「开启技能/关闭技能」按钮（作用于当前选中的技能，开启后底座环变蓝提示）；积雪以蓝色半透明地面+「雪N/冻」标签显示；实现为确定性模型（由部署/技能开关时间推导，拖拽回看一致）；模拟器无HP/伤害系统，雪上每秒20%攻击力法术伤害以减速/冻结表现；天赋2「圣山的祝福」（受击触发）暂不生效；验证：camp_01 纯天赋 t=50 满5层冻结12格且不扩散、4层雪地敌人 dur 8.77 vs 5.26（减速40%）、S2 开启后约5秒扩散至21格并冻结、菜单开关文案正确、近战阻挡回归通过；版本标记 v20260815r→s
